...
public class UserRegistrationController {
    ...
    @FXML
    private CheckBox parkingOwnerRoleCheckBox;
    ...
    @FXML
    private CheckBox vehicleOwnerRoleCheckBox;
    ...
    void handleRegister(ActionEvent event) {
        ...
        String role = vehicleOwnerRoleCheckBox.isSelected() ? "PLAYER" : parkingOwnerRoleCheckBox.isSelected() ? "GROUND_OWNER" : "";
        ...
        try {
            ...
            boolean success = registerUser(username, name, age, city, phone, password, role);
            if (success) {
    ...
    void handleRoleSelection(ActionEvent event) {
        ...
        if (vehicleOwnerRoleCheckBox.isSelected()) {
            parkingOwnerRoleCheckBox.setSelected(false);
        } else if (parkingOwnerRoleCheckBox.isSelected()) {
            vehicleOwnerRoleCheckBox.setSelected(false);
        }
    }

    private boolean registerUser(String username, String name, int age, String city, String phone, String password, String role) {
        String insertQuery = "INSERT INTO users (username, name, age, city, phone, password, role) VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setString(6, password); // You can hash it if needed
            stmt.setString(7, role.equals("PLAYER") ? "VehicleOwner" : "ParkingOwner");
